    ...
    yes: {
      ...
      callback: async (html) => {
        ...
        for (let i = 0; i < baseInput; i++)
        {
          ...
          baseMessage += '<span style="position: relative; text-align: center; color: red; padding: 1px;"><img src="' + roll.results[0].data.img +'" ><div style="position: absolute; left: 50%; transform: translate(0%, -50%);">' + roll.results[0].data.text + '</div></span>';
        }
